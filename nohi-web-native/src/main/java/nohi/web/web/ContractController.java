...
import nohi.web.dto.RsaMesage;
import nohi.web.dto.cont.ContractDataReq;
import nohi.web.dto.cont.ContractDataResp;
import nohi.web.dto.contquery.*;
import nohi.web.feign.ContractFeign;
import nohi.web.utils.JsonUtils;
...
public class ContractController {
    ...
    public String validateAmt(BigDecimal value, String msg) {
        if (null == value) {
            return " " + msg + "不能为空";
    ...
    public String validateStr(String value, String msg) {
    ...
    public String validateDate(String value, String pattern, String msg) {
        if (StringUtils.isBlank(value)) {
            return " " + msg + "不能为空";
        }
